...
//        CGSize timeSize = [_message.strTime sizeWithFont:ChatTimeFont constrainedToSize:CGSizeMake(300, 100) lineBreakMode:NSLineBreakByWordWrapping];
        CGSize infoSize = CGSizeMake(300, 100);
        NSDictionary *dic = @{NSFontAttributeName : ChatTimeFont};
        CGSize timeSize = [_message.strTime boundingRectWithSize:infoSize options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:dic context:nil].size;
...
//            contentSize = [_message.strContent sizeWithFont:ChatContentFont  constrainedToSize:CGSizeMake(ChatContentW, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
            ...
            CGSize infoSize = CGSizeMake(ChatContentW, CGFLOAT_MAX);
            NSDictionary *dic = @{NSFontAttributeName : ChatContentFont};
            contentSize = [_message.strContent boundingRectWithSize:infoSize options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:dic context:nil].size;
